...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sì, puoi clonare la tua voce tramite Inworld IVC. Carica un campione audio e la voce clonata sarà disponibile per tutti i tuoi progetti video, incluso Story Mode.",
  },
  {
    question: "I video generati hanno watermark?",
    answer:
      "I video generati possono includere un watermark leggero a seconda del provider utilizzato.",
  },
];
