      ...
      <section ref={heroRef} className="relative z-10 min-h-[92vh] flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative container mx-auto px-4 text-center max-w-5xl">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.h1 variants={fadeUp} custom={1} className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6 leading-[1.05] [text-shadow:0_2px_0_hsl(225,25%,2%),0_4px_0_hsl(225,25%,3%),0_6px_20px_hsl(225,25%,2%),0_8px_50px_hsl(225,25%,2%),0_0_80px_hsl(225,25%,2%/0.95)] [-webkit-text-stroke:1px_hsl(0,0%,100%/0.15)]">
              <span className="block">All-in-one AI</span>
              <span className="block bg-gradient-to-r from-[hsl(217,91%,60%)] via-[hsl(270,60%,65%)] to-[hsl(25,95%,63%)] bg-clip-text text-transparent [-webkit-text-stroke:0px] drop-shadow-[0_0_30px_hsl(217,91%,60%/0.5)]">
                Video & Image
              </span>
