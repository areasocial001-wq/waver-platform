...
const plans = [
  {
    ...
    price: "€0",
    period: "/mese",
    features: ["5 generazioni video/mese", "Risoluzione 720p", "1 storyboard", "Supporto community"],
    cta: "Inizia Gratis",
    highlighted: false,
  },
  {
    ...
    price: "€19,90",
    period: "/mese",
    features: ["50 generazioni video/mese", "Risoluzione 1080p", "10 storyboard", "Clonazione vocale", "Timeline editor", "Accesso API", "Multi-provider"],
    cta: "Passa a Premium",
    highlighted: true,
  },
  {
    ...
    price: "Contattaci",
    period: "",
    features: ["Generazioni illimitate", "Risoluzione 4K", "Storyboard illimitati", "Clonazione vocale", "Timeline editor", "Accesso API dedicato", "Multi-provider + priorità"],
    cta: "Contattaci",
    highlighted: false,
  },
];
