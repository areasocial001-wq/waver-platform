...
const getPlans = (isAnnual: boolean) => [
  {
    ...
    features: [
      ...
      { name: "1 progetto Story Mode/mese", included: true },
      { name: "Text-to-Speech base", included: true },
      { name: "Workflow AI", included: false },
      { name: "Faceless & Trailer", included: false },
      { name: "Talking Avatar", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "5 progetti Story Mode/mese", included: true },
      { name: "Workflow AI (Freepik, Vidu, LTX)", included: true },
      { name: "Faceless Video & Trailer", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "15 progetti Story Mode/mese", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Storyboard illimitati", included: true },
      { name: "Story Mode illimitato", included: true },
      { name: "Tutti i Workflow AI", included: true },
      { name: "Faceless, Trailer & Avatar", included: true },
      { name: "Voice cloning & Musica AI", included: true },
