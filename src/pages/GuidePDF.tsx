...
const guideSections = [
  { title: "Primi Passi", steps: ["Crea un account con email o Google.", "Conferma il tuo indirizzo email.", "Accedi alla dashboard principale.", "Configura le API key in Impostazioni."], tips: ["Piano Free: 5 video/mese, immagini illimitate.", "Upgrade a Premium/Business in qualsiasi momento."] },
  ...
  { title: "Talking Avatar (Premium)", steps: ["Accedi alla sezione Talking Avatar.", "Carica immagine del volto.", "Scrivi il testo o registra audio.", "Scegli voce o usa Voice Cloning.", "Configura lingua, velocità, emozione.", "Genera e scarica."], tips: ["Batch per produzioni multiple.", "Timeline dedicata per montaggio clip."] },
  { title: "Voice Cloning & TTS (Premium)", steps: ["Apri Voice Clone dalla navigazione.", "Carica campione audio (min. 30 sec).", "Assegna nome alla voce clonata.", "Usa in Talking Avatar o TTS."] },
  { title: "Timeline Editor (Premium)", steps: ["Accedi al Timeline Editor.", "Trascina clip sulla timeline.", "Aggiungi transizioni (dissolve, wipe, zoom).", "Inserisci tracce audio.", "Regola livelli con mixer/equalizzatore.", "Esporta il video finale."] },
  ...
  { title: "Workflow AI (Premium)", steps: ["Accedi al Workflow Freepik.", "Trascina nodi: immagini, video, audio, upscaler.", "Collega i nodi per creare il flusso.", "Configura ogni nodo.", "Esegui il workflow.", "Salva come template."] },
  { title: "Faceless Video (Premium)", steps: ["Accedi a Faceless Video.", "Scegli tipo contenuto.", "Inserisci argomento o script.", "L'AI genera immagini, voiceover e montaggio.", "Personalizza e scarica."] },
  { title: "Trailer Generator (Premium)", steps: ["Accedi al Trailer Generator.", "Seleziona template trailer.", "Carica o genera scene.", "L'AI suggerisce musica e transizioni.", "Personalizza montaggio.", "Esporta in alta qualità."] },
  ...
  { title: "Piani & Abbonamenti", steps: ["Free: 5 video/mese, 720p, 3 storyboard.", "Premium (€19.90/mese): 50 video/mese, 1080p, workflow AI, avatar, voice clone.", "Business (€79.90/mese): Video illimitati, 4K, tutti i workflow, API, supporto prioritario.", "Risparmia 20% con fatturazione annuale."] },
];
